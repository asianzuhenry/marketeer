...
export const HomePage = ({
  ...
  return (
    <div>
      ...
      <section className="w-full h-full p-8 px-60 bg-gray-600 shadow-md">
        ...
        <div className="mt-6">
          ...
          {Services.map((service, index) => (
            <div
              key={index}
              className="mb-4 cursor-pointer bg-gray-200 p-4 rounded h-40 hover:bg-gray-300 transition-colors duration-300"
            >
